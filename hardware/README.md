...
## Learn about DMT TABLET purpose and watch Assembly Instructions

Videos are here (new ones added regularly):

https://www.youtube.com/playlist?list=PLK04xFrNK5BFs3dX_XdjwKGWbj-n-6pDl

<img src="img/zen_explore.jpg">

This is not a mainstream product because it takes a bit of learning / tinkering and most people don't have that much patience.

However, **you can be one of the people that do have enough patience for such explorations!**

DIY / hacker types are especially encouraged to give it a try!

In any case: Stay Foolish and 👽 **Keep up Buidling the Future !**
